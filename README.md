...
| 4             |`Py Package`      | [Common Python Libraries used for AI/ML](https://github.com/nholuongut/AI-ML-Roadmap/blob/main/Packages.md)  |
...
| S.No          | Type          | Course Name   |
| ------------- | ------------- | ------------- |
| 1             |`Course`       | [Fundamental Math for Data Science](https://www.codecademy.com/learn/paths/fundamental-math-for-data-science)| 
...
| S.No          | Type          | Course Name   | 
| ------------- | ------------- | ------------- | 
| 1             | `Website`      | [Data Science Introduction](https://www.w3schools.com/datascience/ds_introduction.asp)           | 
